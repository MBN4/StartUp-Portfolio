      ...
      <div className="container mx-auto px-6 relative z-10 text-center">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <button className="group relative px-8 py-4 bg-neon-green text-background font-bold rounded-full overflow-hidden transition-all hover:scale-105 active:scale-95">
            ...
            <button className="px-8 py-4 glass rounded-full font-semibold transition-all hover:bg-white/5 active:scale-95">
              View Showcase
            </button>
          </div>
        </motion.div>
